              ...
              <Grid item xs={12} md={6}>
                <Card className="">
                  <Box className="flex justify-between items-center p-3">
                    ...
                    <Box className="p-2 rounded-sm text-white bg-blue-500 text-xl">
                      <FaArrowTrendUp />
                    </Box>
                  </Box>
                  <Divider />
              ...
              <Grid item xs={12} md={6}>
                <Card className="">
                  <Box className="flex justify-between items-center p-3">
                    ...
                    <Box className="p-2 bg-blue-500 text-white rounded-sm">
                      <Typography variant="p">Earnings</Typography>
                    </Box>
                  </Box>
                  <Divider />
                  <Box className="flex justify-between items-center px-5 py-4">
                    ...
                    <div className="rounded-full text-xs font-bold text-white bg-blue-500 py-1 px-4">
                  ...
                  <Box className="flex justify-between items-center px-5 py-4">
                    ...
                    <div className="rounded-full text-xs font-bold text-white bg-green-500 py-1 px-4">
                      <Badge badgeContent={4} />
                    </div>
                  </Box>
                  <Divider />
                  <Box className="flex justify-between items-center  px-5 py-4">
                    ...
                    <div className="rounded-full text-xs font-bold text-white bg-yellow-500 py-1 px-4">
                      <Badge badgeContent={4} />
                    </div>
                  </Box>
                  <Divider />
                  <Box className="flex justify-between items-center  px-5 py-4">
                    ...
                    <div className="rounded-full text-xs font-bold text-white bg-red-500 py-1 px-4">
                      <Badge badgeContent={4} />
                    </div>
                  </Box>
                </Card>
              ...
              <Box className="flex flex-col">
                ...
                <Card>
                  ...
                  <Box className="flex items-center justify-between py-2 px-3 ">
                    ...
                    />
                    <Box className="flex flex-col">
                      <Typography variant="p">Angular Unit Testing</Typography>
                      <Typography variant="p">
                        Invoice #8734 - $89 USD
                      </Typography>
                    </Box>
