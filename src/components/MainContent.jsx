      ...
      >
        <div className="flex justify-between items-center">
          <div className="flex  items-center gap-2">
            ...
            <Typography>
              <span className="text-gray6 ">Your subscription ends on </span>
              25 February 2015
            </Typography>
          </div>
        ...
        <Grid item xs={12} md={6}>
          <Card className="p-4">
            ...
            <Typography variant="p">
              ...
              Laudantium quaerat, natus nobis numquam commodi maxime praesentium
              soluta quis rem fuga unde doloribus magni eaque ex
            </Typography>
          </Card>
          <Card className="mt-5">
          ...
          <Card className="">
            ...
            <CardContent className="">
              <div className="flex justify-between items-center p-3">
                <Box className="flex gap-2">
                  <div className="flex flex-col">
                    ...
                    <Typography variant="p">
                      COURSE{" "}
                      <span className="text-blue text-lg">Basics of HTML</span>
                    </Typography>
                  </div>
                </Box>
                <Box className="flex gap-2 items-center">
              ...
              <div className="flex justify-between items-center p-3">
                <Box className="flex gap-2">
                  <div className="flex flex-col">
                    <Typography variant="p">Directives & Routing</Typography>
                    <Typography variant="p">
                      COURSE{" "}
